...
CREATE TABLE ADVISOR(
    ...
    ADVISOR_OFFICE_NUM INTEGER UNIQUE,
...
CREATE TABLE CLASS(
    ...
    `CLASS_CREDITS` int(11) DEFAULT 4,
...
CREATE TABLE PROFESSOR(
    ...
    `PROF_OFFICE_NUM` int(11) UNIQUE,
    `PROF_EMAIL` varchar(50) NOT NULL,
    `PROF_BACKGROUND` varchar(1000) DEFAULT NULL,
    `PROF_RATING` decimal(2,1) DEFAULT NULL,
    `PROF_RATING_LINK` varchar(255) DEFAULT NULL
);
...
(1420, 'CSI', 'Introduction to C Programming and Unix', 4, "Topics include binary numbers and C programming concepts such as data types, bitwise operations, control flow, arrays, pointers, structures, and input/output. Basic Unix commands and shell programming are covered, as well as Unix utilities for developing and debugging C programs. With laboratory.", "https://www-personal.acfr.usyd.edu.au/tbailey/ctext/ctext.pdf"),
(1440, 'CHM', 'General Chemistry I', 4, "States of matter, atomic structure, bonding and molecular structure, chemical reactions. Recommended preparation is three years high school mathematics and one year of high school chemistry.", "https://www.academia.edu/41741225/Chemistry_11th_Edition"),
(1554, 'MTH', 'Calculus I', 4, "A detailed study of limits, continuity, derivatives of algebraic and transcendental functions, applications of derivatives, numerical techniques, integrals and the Fundamental Theorem of Calculus.", "https://openstax.org/books/calculus-volume-1/pages/1-introduction"),
...
(2400, 'EGR', 'Introduction to Electrical and Computer Engineering', 4, "An introduction to the fundamentals of electrical and computer engineering, DC and AC circuits, digital logic circuits, combinational logic design, sequential circuits, introduction to electronics, operational amplifiers and DC electromechanical machines. With laboratory. Offered fall and winter.", "https://www.csl.cornell.edu/~cbatten/misc/batten-ece-engrg1060-2012.pdf"),
(2440, 'CSI', 'Computer Systems', 4, "Introduction to computer hardware and operating systems. Hardware topics include processors, GPU’s, memory, secondary storage devices, and other I/O devices and interfaces. Operating systems topics include file systems, memory management, and process management.", "https://ocw.mit.edu/courses/res-6-004-principles-of-computer-system-design-an-introduction-spring-2009/pages/online-textbook/"),
(2460, 'CSI', 'Fundamentals of Cybersecurity', 4, "This course covers topics relevant to cybersecurity across many disciplines. Discussions include the CIA triad, cryptography and privacy basics, hardware, and software security risks, guiding principles and cybersecurity ethics. In all, eight knowledge areas are explored: Data Security, Software Security, Component Security, Connection Security, Systems Security, Human Security, Organizational Security, and Societal Security.", "https://heimdalsecurity.com/pdf/cyber_security_for_beginners_ebook.pdf"),
...
(3380, 'CSI', 'Game Design', 4, 'This course teaches modern methods for designing and assessing the design of digital games. The course distinguishes game design from game development. Students learn theory, concepts, and industry best-practices for designing and critically analyzing games. Students apply this understanding to iteratively design their own games with popular game prototyping software.', "https://www.amazon.com/Game-Programming-Computers-Internet-Books/b?node=15375251"),
(3400, 'BIO', 'Genetics', 4, 'Fundamentals of classical and molecular genetics. Selected topics in human genetics, microbial genetics, biochemical genetics, molecular biology, cytogenetics and genomics. Offered fall and winter semesters.', "https://drive.google.com/file/d/1JEkRrsTlwoyI9aXURx4c8TAeTXoKPsgC/view"),
...
(4700, 'CSI', 'Software Security', 4, "Introduction to research in foundations of software security. This course surveys common software vulnerabilities, including buffer overflows, format string attacks, cross-site scripting and botnets. The course also discusses common defense mechanisms, including static code analysis, reference monitors, language-based security, secure information flow and others.", "https://www.pearsonhighered.com/assets/samplechapter/0/2/0/1/020172152X.pdf"),
