...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/advisorapp.css" />


    <link rel="shortcut icon" href="../pictures/mydegreeFavicon.png" type="image/x-icon" />
    <!-- <link rel="shortcut icon" href="../css/advisorapp.css"/>  -->
...
<body class="bg-light">
    ...
    <div class="banner">
        ...
        <!-- <p class="text-center">CHow can I contact my Academic Adviser? 
                   Connect with us during an appointment, chat, or email:
                    Schedule an in-person or virtual appointment (instructions): https://oakland.trac.cloud
                    ...
                    <!-- <p class="text-uppercase">How can I contact my Academic Adviser?</p> -->
                    <div class= "mx-5">
                    <div class ="mt-5">

                    <!-- <p class="fw-bolder">How can I contact my Academic Adviser?</p> -->
                    <h4>How can I contact my Academic Adviser?</h4>
                    <p class="text-start">Connect with us during an appointment, chat, or email:
