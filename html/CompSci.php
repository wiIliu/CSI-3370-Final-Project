...
$admissionsData = getAdmissionsData(1);
$admissions = $admissionsData[0];
$desc = $admissionsData[1];
$advisor = getAdvisor(1);
?>
...
<body class="bg-light" onload="updateProgress()">
  ...
  <div class="banner">
            ...
            <li class="nav-item dropdown pe-2">
              <div class="btn-group">
                ...
                <ul class="dropdown-menu" data-bs-theme="dark" style="background-color: #073352;   border-radius: 8px; top: 35px; padding: 1em 0;" aria-labelledby="dropdownMenuLink">
                  ...
                  <li><a class="dropdown-item pb-1 mx-0" href="#">Computer Science</a></li>
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-left mt-2 ms-5 ps-4">
        <h3 class="text-decoration-underline">Course List (86 Credits):</h3>
        <?php
        $count = 0;
        while ($row = mysqli_fetch_array($classes)) :
          ...
          if ($count == 0) {
            ...
            echo "<h5 class='mb-3 mt-4 fw-semibold'>Computer Science Core (18 credits)&nbsp;
            ...
            <span class='fw-semibold pb-2 mb-1' style='font-size: 1.08em;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Computational Intelligence Track:</span>";
          } else if ($count == 26) {
            echo "<span class='fw-semibold pb-2 my-1' style='font-size: 1.08em;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System Administration Track:</span>";
          } else if ($count == 28) {
            echo "<span class='fw-semibold pb-2 my-1' style='font-size: 1.08em;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cybersecurity Track:</span>";
          } else if ($count == 32) {
            echo "<span class='fw-semibold pb-2 my-1' style='font-size: 1.08em;'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Web Development Track:</span>";
          }
        ?>
          <div class="mb-3">
            <!-- CHECK BOXES -->
      ...
      <div class="row m-5 p-2">
        <h5 class="pb-1 pt-2"><strong>Computer Science Jobs and Careers:</strong></h5>
        <p>Computer Science is a broad and dynamic field that offers a wide range of jobs and careers across various industries.<br>Here are some common computer science job and career paths:</p>
        <ul class="list-group">
          <ol>
      ...
      <div class="modal fade text-dark" id="profPopup" tabindex="-1" data-bs-theme="dark" 
          aria-labelledby="professorPopup" aria-hidden="true"> <!-- style="white-space: pre-line;" -->
  ...
  <script>
    ...
    function addToStorage(id){
      if(document.getElementById(id).checked){localStorage.setItem(id,id);}
