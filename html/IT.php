        ...
        <ul class="navbar-nav nav">
          ...
          <li class="nav-item"><a class="nav-link fw-medium" href="majorPage.php">MAJOR</a>
            <ul class="dropdown">
              ...
              <li><a class="mx-0" href="#">Information Technology</a></li>
      ...
      <div class="row justify-content-left mt-5 ms-5 ps-4">
        ...
        while ($row = mysqli_fetch_array($classes)) :
          if ($count == 0) {
            ...
            echo "<h5 class='mb-3 mt-4 fw-semibold'>Information Technology Core (18 credits)<br></h5>";
